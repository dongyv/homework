...
<title>优惠券</title>
	<link href="<%=contextPath %>/AmazeUI-2.4.2/assets/css/admin.css" rel="stylesheet" type="text/css">
		...
		<link href="<%=contextPath %>/css/cpstyle.css" rel="stylesheet" type="text/css">
									...
									<div class="coupon-items">
											...
											<div class="coupon-list">
												...
												<li class="td td-usestatus ">
													<div class="item-usestatus ">
														<span><img src="<%=contextPath %>/images/gift_stamp_31.png"/></span>
													</div>
												</li>												
											</div>
										</div>
										<div class="coupon-item coupon-item-yf">
											<div class="coupon-list">
												...
												<li class="td td-usestatus ">
													<div class="item-usestatus ">
														<span><img src="<%=contextPath %>/images/gift_stamp_21.png"/></span>
													</div>
												</li>
											</div>
										</div>
