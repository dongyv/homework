...
<head>
	...
	<link href="<%=contextPath %>/css/systyle.css" rel="stylesheet" type="text/css">
</head>
<body>
		<!--头 -->
		<header>
					...
					<div class="wrap-left">
						<div class="wrap-list">
							<div class="m-user">
								...
								<div class="m-userinfo">
									...
									<div class="m-right">
										...
										<div class="m-address">
											<a href="${path }/person/address.jsp" class="i-trigger">我的收货地址</a>
										</div>
									</div>
								</div>
								...
								<div class="m-userproperty">
									...
									<p class="m-bonus">
										<a href="bonus.jsp">
											<i><img src="<%=contextPath %>/images/bonus.png"/></i>
									...
									<p class="m-coupon">
										<a href="coupon.jsp">
											<i><img src="<%=contextPath %>/images/coupon.png"/></i>
									...
									<p class="m-bill">
										<a href="bill.jsp">
											<i><img src="<%=contextPath %>/images/wallet.png"/></i>
									...
									<p class="m-big">
										<a href="#">
											<i><img src="<%=contextPath %>/images/day-to.png"/></i>
											<span class="m-title">签到有礼</span>
										</a>
									</p>
									<p class="m-big">
										<a href="#">
											<i><img src="<%=contextPath %>/images/72h.png"/></i>
							...
							<div class="m-order">
								...
								<ul>
									<li><a href="order.jsp"><i><img src="<%=contextPath %>/images/pay.png"/></i><span>待付款</span></a></li>
									<li><a href="order.jsp"><i><img src="<%=contextPath %>/images/send.png"/></i><span>待发货<em class="m-num">1</em></span></a></li>
									<li><a href="order.jsp"><i><img src="<%=contextPath %>/images/receive.png"/></i><span>待收货</span></a></li>
									<li><a href="order.jsp"><i><img src="<%=contextPath %>/images/comment.png"/></i><span>待评价<em class="m-num">3</em></span></a></li>
									<li><a href="change.jsp"><i><img src="<%=contextPath %>/images/refund.png"/></i><span>退换货</span></a></li>
								</ul>
							</div>
							<!--九宫格-->
							<div class="user-patternIcon">
								...
								<ul>
									...
									<a href="<%=contextPath %>/home/shopcart.jsp"><li class="am-u-sm-4"><i class="am-icon-shopping-basket am-icon-md"></i><img src="<%=contextPath %>/images/iconbig.png"/><p>购物车</p></li></a>
									<a href="collection.jsp"><li class="am-u-sm-4"><i class="am-icon-heart am-icon-md"></i><img src="<%=contextPath %>/images/iconsmall1.png"/><p>我的收藏</p></li></a>
									<a href="<%=contextPath %>/home/home.jsp"><li class="am-u-sm-4"><i class="am-icon-gift am-icon-md"></i><img src="<%=contextPath %>/images/iconsmall0.png"/><p>为你推荐</p></li></a>
									<a href="comment.jsp"><li class="am-u-sm-4"><i class="am-icon-pencil am-icon-md"></i><img src="<%=contextPath %>/images/iconsmall3.png"/><p>好评宝贝</p></li></a>
									<a href="foot.jsp"><li class="am-u-sm-4"><i class="am-icon-clock-o am-icon-md"></i><img src="<%=contextPath %>/images/iconsmall2.png"/><p>我的足迹</p></li></a>                                                                        
								</ul>
							</div>
							<!--物流 -->
								...
								<div class="s-content">
									<ul class="lg-list">
										...
										<li class="lg-item">
											<div class="item-info">
												<a href="#">
													<img src="<%=contextPath %>/images/65.jpg_120x120xz.jpg" alt="抗严寒冬天保暖隔凉羊毛毡底鞋垫超薄0.35厘米厚吸汗排湿气舒适">
												</a>
										...
										<li class="lg-item">
											<div class="item-info">
												<a href="#">
													<img src="<%=contextPath %>/images/88.jpg_120x120xz.jpg" alt="礼盒袜子女秋冬 纯棉袜加厚 女式中筒袜子 韩国可爱 女袜 女棉袜">
												</a>
		...
		<!--引导 -->
		<div class="navCir">
			<li><a href="<%=contextPath %>/home/home.jsp"><i class="am-icon-home "></i>首页</a></li>
			<li><a href="<%=contextPath %>/home/sort.jsp"><i class="am-icon-list"></i>分类</a></li>
			<li><a href="<%=contextPath %>/home/shopcart.jsp"><i class="am-icon-shopping-basket"></i>购物车</a></li>	
