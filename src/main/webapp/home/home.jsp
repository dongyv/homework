...
<title>首页</title>
	...
	<link href="<%=contextPath %>/css/hmstyle.css" rel="stylesheet" type="text/css"/>
	<link href="<%=contextPath %>/css/skin.css" rel="stylesheet" type="text/css" />
	...
	<script>
		function jrgwc(id){
			var mid = id.parentNode.parentNode.childNodes[1].value;
			var sid = id.parentNode.parentNode.parentNode.childNodes[1].value;
			$.ajax({
				type : "POST",  //提交方式  
	            url : "${path}/user_shopcard/gwc.dongyv",//路径  
	            dataType:"json",
	            async:false,
	            data : {  
	                "mid" : mid,
			...
			<div class="banner">
                      <!--轮播 -->
						<div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
							<ul class="am-slides">
								<li class="banner1"><a href="../home/introduction.jsp"><img src="<%=contextPath %>/images/ad1.jpg" /></a></li>
								<li class="banner2"><a><img src="<%=contextPath %>/images/ad2.jpg" /></a></li>
								<li class="banner3"><a><img src="<%=contextPath %>/images/ad3.jpg" /></a></li>
								<li class="banner4"><a><img src="<%=contextPath %>/images/ad4.jpg" /></a></li>
			...
			<div class="shopNav">
				<div class="slideall">
										...
										<ul class="category-list" id="js_climit_li">
											<li class="appliance js_toggle relative first">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=contextPath %>/images/cake.png"></i><a class="ml-22" title="点心">点心/蛋糕</a></h3>
													<em>&gt;</em></div>
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=contextPath %>/images/cookies.png"></i><a class="ml-22" title="饼干、膨化">饼干/膨化</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=contextPath %>/images/meat.png"></i><a class="ml-22" title="熟食、肉类">熟食/肉类</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=contextPath %>/images/bamboo.png"></i><a class="ml-22" title="素食、卤味">素食/卤味</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=contextPath %>/images/nut.png"></i><a class="ml-22" title="坚果、炒货">坚果/炒货</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=contextPath %>/images/candy.png"></i><a class="ml-22" title="糖果、蜜饯">糖果/蜜饯</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=contextPath %>/images/chocolate.png"></i><a class="ml-22" title="巧克力">巧克力</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=contextPath %>/images/fish.png"></i><a class="ml-22" title="海味、河鲜">海味/河鲜</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=contextPath %>/images/tea.png"></i><a class="ml-22" title="花茶、果茶">花茶/果茶</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative last">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=contextPath %>/images/package.png"></i><a class="ml-22" title="品牌、礼包">品牌/礼包</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
					...
					<div class="am-g am-g-fixed smallnav">
						<div class="am-u-sm-3">
							<a href="sort.jsp"><img src="<%=contextPath %>/images/navsmall.jpg" />
								<div class="title">商品分类</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="<%=contextPath %>/images/huismall.jpg" />
								<div class="title">大聚惠</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="../person/index.jsp"><img src="<%=contextPath %>/images/mansmall.jpg" />
								<div class="title">个人中心</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="<%=contextPath %>/images/moneysmall.jpg" />
					...
					<div class="marqueen">
						...
						<div class="demo">
							...
							<ul>
								<li class="title-first"><a target="_blank" href="#">
									<img src="<%=contextPath %>/images/TJ2.jpg"></img>
									<span>[特惠]</span>商城爆品1分秒								
								</a></li>
								<li class="title-first"><a target="_blank" href="#">
									<span>[公告]</span>商城与广州市签署战略合作协议
								     <img src="<%=contextPath %>/images/TJ.jpg"></img>
								     <p>XXXXXXXXXXXXXXXXXX</p>
							    </a></li>
							    
						<div class="mod-vip">
							<div class="m-baseinfo">
								<a href="<%=contextPath %>/person/index.jsp">
                        ...
                        <div class="advTip"><img src="<%=contextPath %>/images/advTip.jpg"/></div>
						</div>
					</div>
					<div class="clear"></div>
				</div>
				...
				<div class="shopMain" id="shopmain">
					...
					<div class="am-g am-g-fixed recommendation">
						<div class="clock am-u-sm-3" ">
							<img src="<%=contextPath %>/images/2016.png "></img>
							<p>今日<br>推荐</p>
						</div>
						<div class="am-u-sm-4 am-u-lg-3 ">
							...
							<div class="recommendationMain one">
								<a href="introduction.jsp"><img src="<%=contextPath %>/images/tj.png "></img></a>
							</div>
						</div>						
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain two">
								<img src="<%=contextPath %>/images/tj1.png "></img>
							</div>
						</div>
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain three">
								<img src="<%=contextPath %>/images/tj2.png "></img>
							</div>
						</div>
					  ...
					  <div class="am-g am-g-fixed ">
						<div class="am-u-sm-3 ">
							...
							<div class="activityMain ">
								<img src="<%=contextPath %>/images/activity1.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>														
						...
						<div class="am-u-sm-3 ">
						  <div class="icon-sale two "></div>	
							<h4>特惠</h4>
							<div class="activityMain ">
								<img src="<%=contextPath %>/images/activity2.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>								
							</div>							
						...
						<div class="am-u-sm-3 ">
							...
							<h4>团购</h4>
							<div class="activityMain ">
								<img src="<%=contextPath %>/images/activity3.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>							
						...
						<div class="am-u-sm-3 last ">
							...
							<h4>超值</h4>
							<div class="activityMain ">
								<img src="<%=contextPath %>/images/activity.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>													
					...
					<c:forEach var="shoplist" items="${shop_list }">
                    <div id="f1">
					<!--甜点-->
...
<!--                     <a href="# ">更多商品<i class="am-icon-angle-right" style="padding-left:10px ;" ></i></a> -->
					...
					<div class="am-g am-g-fixed floodFour">
						<input type="hidden" value="${shoplist.id }">
...
<!-- 									</div>									 -->
<!-- 								</div> -->
<%--                                   <img src="<%=contextPath %>/images/act1.png " />								 --%>
<!-- 							</a> -->
<!-- 							<div class="triangle-topright"></div>						 -->
						</div>
						
							<c:forEach var="merchandiselist" items="${shoplist.merchandise }">
								<div class="am-u-sm-7 am-u-md-4 ">
									<input type="hidden" value="${merchandiselist.id }">
									<div class="outer-con ">
										<div class="title ">
											${merchandiselist.name }
										</div>									
										<div class="sub-title ">
											¥${merchandiselist.price }
										</div>
										<i class="am-icon-shopping-basket am-icon-md  seprate" onclick="jrgwc(this)"></i>
									</div>
									<a href="# "><img style="wind:20px;height:240px" src="<%=contextPath %>/images/2.jpg" /></a>
								</div>
							</c:forEach>
...
<!-- 								</div> -->
<%-- 								<a href="# "><img src="<%=contextPath %>/images/1.jpg" /></a> --%>
<!-- 							</div> -->
...
<!-- 								<i class="am-icon-shopping-basket am-icon-md  seprate"></i> -->
<!-- 							</div> -->
<%-- 							<a href="# "><img src="<%=contextPath %>/images/5.jpg" /></a> --%>
<!-- 						</div> -->
...
<!-- 								<i class="am-icon-shopping-basket am-icon-md  seprate"></i> -->
<!-- 							</div> -->
<%-- 							<a href="# "><img src="<%=contextPath %>/images/3.jpg" /></a> --%>
<!-- 						</div> -->
...
<!-- 								<i class="am-icon-shopping-basket am-icon-md  seprate"></i> -->
<!-- 							</div> -->
<%-- 							<a href="# "><img src="<%=contextPath %>/images/4.jpg" /></a> --%>
<!-- 						</div> -->
...
<!-- 						</div> -->
		...
		<div class="navCir">
			...
			<li><a href="<%=contextPath %>/person/index.jsp"><i class="am-icon-user"></i>我的</a></li>					
		</div>


		<jsp:include page="tip.jsp" />
		<script>
			window.jQuery || document.write('<script src="<%=contextPath %>/basic/js/jquery.min.js "><\/script>');
		</script>
		<script type="text/javascript " src="<%=contextPath %>/basic/js/quick_links.js "></script>
</body>
</html>