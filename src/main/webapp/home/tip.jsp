			...
			<div id="sidebar">
				<div id="wrap">
						...
						<div class="ibar_login_box status_login ">
							<div class="avatar_box ">
								<p class="avatar_imgbox ">
									<img src="<%=contextPath%>/images/no-img_mid_.jpg " />
								</p>
								<ul class="user_info ">
									<li>昵称:${user.name }</li>
									<li>级&nbsp;别普通会员</li>
							...
							<div class="login_btnbox ">
								<a href="?id=${user.id } " class="login_order ">我的订单</a> <a
									href="?id=${user.id } " class="login_favorite ">我的收藏</a>
							</div>
					...
					<div id="shopCart " class="item ">
						<a href="${path }/home/toShopCart1.dongyv "> <span class="message "></span>
						</a>
						<p>购物车</p>
					...
					<div id="brand " class="item ">
						<a href="#"> <span class="wdsc "><img
								src="<%=contextPath%>/images/wdsc.png " /></span>
						</a>
						<div class="mp_tooltip ">
					...
					<div id="broadcast " class="item ">
						<a href="# "> <span class="chongzhi "><img
								src="<%=contextPath%>/images/chongzhi.png " /></span>
						</a>
						<div class="mp_tooltip ">
					...
					<div class="quick_toggle ">
						...
						<li class="qtitem "><a href="#none "><span
							...
							<div class="mp_qrcode " style="display: none;">
								<img src="<%=contextPath%>/images/weixin_code_145.png " /><i
