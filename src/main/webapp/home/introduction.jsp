...
<link href="<%=contextPath%>/basic/css/demo.css" rel="stylesheet"
	type="text/css" />
<link type="text/css" href="<%=contextPath%>/css/optstyle.css"
	rel="stylesheet" />
<link type="text/css" href="<%=contextPath%>/css/style.css"
	rel="stylesheet" />

<script type="text/javascript"
	src="<%=contextPath%>/basic/js/jquery-1.7.min.js"></script>
<script type="text/javascript"
	src="<%=contextPath%>/basic/js/quick_links.js"></script>

<script type="text/javascript"
	src="<%=contextPath%>/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
<script type="text/javascript"
	src="<%=contextPath%>/js/jquery.imagezoom.min.js"></script>
<script type="text/javascript"
	src="<%=contextPath%>/js/jquery.flexslider.js"></script>
	...
	<div class="listMain">
		...
		<div class="scoll">
			...
			<div class="flexslider">
				<ul class="slides">
					<li><img src="<%=contextPath%>/images/01.jpg" title="pic" />
					</li>
					<li><img src="<%=contextPath%>/images/02.jpg" /></li>
					<li><img src="<%=contextPath%>/images/03.jpg" /></li>
				</ul>
			</div>
			</section>
		</div>
			...
			<div class="clearfixLeft" id="clearcontent">
				...
				<div class="box">
					...
					<div class="tb-booth tb-pic tb-s310">
						<a href="<%=contextPath%>/images/01.jpg"><img
							src="<%=contextPath%>/images/01_mid.jpg" alt="细节展示放大镜特效"
							rel="<%=contextPath%>/images/01.jpg" class="jqzoom" /></a>
					</div>
					<ul class="tb-thumb" id="thumblist">
						<li class="tb-selected">
							<div class="tb-pic tb-s40">
								<a href="#"><img src="<%=contextPath%>/images/01_small.jpg"
									mid="<%=contextPath%>/images/01_mid.jpg"
									big="<%=contextPath%>/images/01.jpg"></a>
							</div>
						</li>
						<li>
							<div class="tb-pic tb-s40">
								<a href="#"><img src="<%=contextPath%>/images/02_small.jpg"
									mid="<%=contextPath%>/images/02_mid.jpg"
									big="<%=contextPath%>/images/02.jpg"></a>
							</div>
						</li>
						<li>
							<div class="tb-pic tb-s40">
								<a href="#"><img src="<%=contextPath%>/images/03_small.jpg"
									mid="<%=contextPath%>/images/03_mid.jpg"
									big="<%=contextPath%>/images/03.jpg"></a>
							</div>
						</li>
					</ul>
				</div>
				...
				<div class="tb-detail-list">
					...
					<div class="tb-detail-price">
						<li class="price iteminfo_price">
							<dt>促销价</dt>
							<dd>
								<em>¥</em><b class="sys_item_price">56.90</b>
							</dd>
						</li>
								...
								<div class="theme-popbod dform">
									<form class="theme-signin" name="loginform" action=""
										...
										<div class="theme-signin-right">
											<div class="img-info">
												<img src="<%=contextPath%>/images/songzi.jpg" />
											</div>
											<div class="text-info">
			...
			<div class="match-comment">
				<ul class="like_list">
					<li>
						<div class="s_picBox">
							<a class="s_pic" href="#"><img
								src="<%=contextPath%>/images/cp.jpg"></a>
					...
					<li>
						<div class="s_picBox">
							<a class="s_pic" href="#"><img
								src="<%=contextPath%>/images/cp2.jpg"></a>
				...
				<div class="mc">
					<ul>
						...
						<li class="first">
							<div class="p-img">
								<a href="#"> <img class=""
									src="<%=contextPath%>/images/browse1.jpg">
								</a>
							</div>
							<div class="p-name">
						...
						<div class="am-tab-panel am-fade am-in am-active">
							...
							<div class="details">
								...
								<div class="twlistNews">
									<img src="<%=contextPath%>/images/tw1.jpg" /> <img
										src="<%=contextPath%>/images/tw2.jpg" /> <img
										src="<%=contextPath%>/images/tw3.jpg" /> <img
										src="<%=contextPath%>/images/tw4.jpg" /> <img
										src="<%=contextPath%>/images/tw5.jpg" /> <img
										src="<%=contextPath%>/images/tw6.jpg" /> <img
										src="<%=contextPath%>/images/tw7.jpg" />
								</div>
							</div>
							<div class="clear"></div>
							...
							<ul class="am-comments-list am-comments-list-flip">
								<li class="am-comment">
									<!-- 评论容器 --> <a href=""> <img class="am-comment-avatar"
										src="<%=contextPath%>/images/hwbn40x40.jpg" /> <!-- 评论者头像 -->
								</a>
